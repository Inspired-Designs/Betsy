...
INSERT INTO pictures (item_id) VALUES 
(1);

-- INSERT BLOCK FOR REVIEWS TABLE
-- NEED TO INSERT ACTUAL PICTCUREID AND ITEM ID IN PLACE OF NULL VALUES
INSERT INTO reviews (reviewers_name, rating, rating_item_qual, rating_shipping, review_text, recommend, review_date, picture_id, item_id)
VALUES 
('Jess Lewis', 5, NULL, NULL, 'Beautiful necklace, surpassed my expectations. I chose the 18” gold and it was longer on me than expected so I just clasped it 3 chains shorter and it’s perfect. And if I want it longer I can clasp it how it’s intended. Wonderful!', TRUE, CURRENT_DATE, 1, 1);
...
INSERT INTO shipping (shipping_cost, delivery_zip, delivery_country, origin_city, origin_state, item_id)
VALUES 
